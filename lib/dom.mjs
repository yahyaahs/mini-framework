function parseHTML(str) {
    ...
    const doc = parser.parseFromString(`<div id="app">${str}</div>`, 'text/html');
    clean(doc.body);
...
// Virtual DOM creator 
function vDom(tag, attrs = {}, children = []) {
    return { tag, attrs, children };
}

function render(newNode, targetNode) {
    clean(targetNode);
    diff(newNode, targetNode);
}

// you could either use vdom to create dom elemnt 
// or create html and use parsehtml to parse it to vdom and render it 
export { vDom, parseHTML, render };